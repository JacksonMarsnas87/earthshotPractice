...
function SvgComponent() {
  return (
    <svg fill="#e00000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 554.2 554.199" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)" stroke="#e00000">
